...
>>>>>>> 1ff4739034cc828d0307458b101417b4c2abcd3a
    ...
    struct list_elem donatelem;
    struct list_elem sleepelem;

    /* Advanced scheduler vars */
    int nice;                          /* A Thread's niceness value, used for BSD Scheduling */
    int recent_cpu;                    /* Number of clock ticks a thread has used  */ 
